...
/* Private defines -----------------------------------------------------------*/
#define USB_DETECT_Pin GPIO_PIN_14
#define USB_DETECT_GPIO_Port GPIOC
#define CAN_MODE_Pin GPIO_PIN_15
